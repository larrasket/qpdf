...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__ShortcutHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qpdfview__ShortcutHandler_t qt_meta_stringdata_qpdfview__ShortcutHandler = {
    {
QT_MOC_LITERAL(0, 0, 25), // "qpdfview::ShortcutHandler"
QT_MOC_LITERAL(1, 26, 6), // "submit"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 6), // "revert"
QT_MOC_LITERAL(4, 41, 5) // "reset"
...
void qpdfview::ShortcutHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ShortcutHandler *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject qpdfview::ShortcutHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractTableModel::staticMetaObject>(),
    qt_meta_stringdata_qpdfview__ShortcutHandler.data,
    qt_meta_data_qpdfview__ShortcutHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *qpdfview::ShortcutHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__ShortcutHandler.stringdata0))
