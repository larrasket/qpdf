...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__SearchModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qpdfview__SearchModel_t qt_meta_stringdata_qpdfview__SearchModel = {
    {
QT_MOC_LITERAL(0, 0, 21), // "qpdfview::SearchModel"
QT_MOC_LITERAL(1, 22, 32), // "on_fetchSurroundingText_finished"
...
QT_INIT_METAOBJECT const QMetaObject qpdfview::SearchModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractItemModel::staticMetaObject>(),
    qt_meta_stringdata_qpdfview__SearchModel.data,
    qt_meta_data_qpdfview__SearchModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *qpdfview::SearchModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__SearchModel.stringdata0))
