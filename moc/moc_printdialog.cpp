...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__PrintDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qpdfview__PrintDialog_t qt_meta_stringdata_qpdfview__PrintDialog = {
    {
QT_MOC_LITERAL(0, 0, 21), // "qpdfview::PrintDialog"
...
QT_INIT_METAOBJECT const QMetaObject qpdfview::PrintDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QPrintDialog::staticMetaObject>(),
    qt_meta_stringdata_qpdfview__PrintDialog.data,
    qt_meta_data_qpdfview__PrintDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *qpdfview::PrintDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__PrintDialog.stringdata0))
