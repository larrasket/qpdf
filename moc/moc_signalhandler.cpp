...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__SignalHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qpdfview__SignalHandler_t qt_meta_stringdata_qpdfview__SignalHandler = {
    {
QT_MOC_LITERAL(0, 0, 23), // "qpdfview::SignalHandler"
QT_MOC_LITERAL(1, 24, 14), // "sigIntReceived"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 15), // "sigTermReceived"
QT_MOC_LITERAL(4, 56, 27) // "on_socketNotifier_activated"
...
void qpdfview::SignalHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignalHandler::sigIntReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SignalHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignalHandler::sigTermReceived)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject qpdfview::SignalHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_qpdfview__SignalHandler.data,
    qt_meta_data_qpdfview__SignalHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *qpdfview::SignalHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__SignalHandler.stringdata0))
